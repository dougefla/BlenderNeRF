...
PROPS = [
    ...
    ('sequential_trajectory', bpy.props.BoolProperty(name='Sequential Trajectory', description='Whether to create a sequential camera trajectory around the sphere instead of random positions', default=False) ),
    ('cos_nb_frames', bpy.props.IntProperty(name='Frames', description='Number of training frames. Sequential trajectory: frames distributed evenly around sphere. Random: frames sampled randomly from sphere', default=100, soft_min=1) ),
